...
namespace IO.Swagger.Api
{
    ...
    public interface IPetApi : IApiAccessor
    {
        ...
        ApiResponse UploadFile(long? petId, string additionalMetadata = null, Stream _file = null);
        ...
        ApiResponse<ApiResponse> UploadFileWithHttpInfo(long? petId, string additionalMetadata = null,
            Stream _file = null);
        ...
        Task<ApiResponse<Object>> AddPetAsyncWithHttpInfo(Pet body);
        ...
        /// <param name="apiKey"> (optional)</param>
        /// <returns>Task of void</returns>
        Task DeletePetAsync(long? petId, string apiKey = null);
        ...
        /// <param name="apiKey"> (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<Object>> DeletePetAsyncWithHttpInfo(long? petId, string apiKey = null);
        ...
        Task<ApiResponse<List<Pet>>> FindPetsByStatusAsyncWithHttpInfo(List<string> status);
        ...
        /// <param name="tags">Tags to filter by</param>
        /// <returns>Task of ApiResponse (List&lt;Pet&gt;)</returns>
        Task<ApiResponse<List<Pet>>> FindPetsByTagsAsyncWithHttpInfo(List<string> tags);
        ...
        Task<ApiResponse<Pet>> GetPetByIdAsyncWithHttpInfo(long? petId);
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<Object>> UpdatePetAsyncWithHttpInfo(Pet body);
        ...
        /// <param name="status">Updated status of the pet (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<Object>> UpdatePetWithFormAsyncWithHttpInfo(long? petId, string name = null,
            string status = null);
        ...
        /// <param name="_file">file to upload (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse> UploadFileAsync(long? petId, string additionalMetadata = null, Stream _file = null);
        ...
        Task<ApiResponse<ApiResponse>> UploadFileAsyncWithHttpInfo(long? petId, string additionalMetadata = null,
            Stream _file = null);
    ...
    public class PetApi : IPetApi
    {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> AddPetAsyncWithHttpInfo(Pet body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PetApi->AddPet");
        ...
        public ApiResponse<Object> DeletePetWithHttpInfo(long? petId, string apiKey = null)
        {
            ...
            if (petId != null)
                localVarPathParams.Add("petId", Configuration.ApiClient.ParameterToString(petId)); // path parameter
            if (apiKey != null)
                localVarHeaderParams.Add("api_key",
                    Configuration.ApiClient.ParameterToString(apiKey)); // header parameter
        ...
        /// <param name="apiKey"> (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> DeletePetAsyncWithHttpInfo(long? petId, string apiKey = null)
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
                throw new ApiException(400, "Missing required parameter 'petId' when calling PetApi->DeletePet");
        ...
        public ApiResponse<List<Pet>> FindPetsByStatusWithHttpInfo(List<string> status)
        {
            ...
            if (status == null)
                throw new ApiException(400,
                    "Missing required parameter 'status' when calling PetApi->FindPetsByStatus");
            ...
            if (status != null)
                localVarQueryParams.AddRange(
                    Configuration.ApiClient.ParameterToKeyValuePairs("multi", "status", status)); // query parameter
        ...
        /// <param name="status">Status values that need to be considered for filter</param>
        /// <returns>Task of ApiResponse (List&lt;Pet&gt;)</returns>
        public async Task<ApiResponse<List<Pet>>> FindPetsByStatusAsyncWithHttpInfo(List<string> status)
        {
            // verify the required parameter 'status' is set
            if (status == null)
                throw new ApiException(400,
        ...
        public ApiResponse<List<Pet>> FindPetsByTagsWithHttpInfo(List<string> tags)
        {
            ...
            if (tags != null)
                localVarQueryParams.AddRange(
                    Configuration.ApiClient.ParameterToKeyValuePairs("multi", "tags", tags)); // query parameter
        ...
        /// <param name="tags">Tags to filter by</param>
        /// <returns>Task of ApiResponse (List&lt;Pet&gt;)</returns>
        public async Task<ApiResponse<List<Pet>>> FindPetsByTagsAsyncWithHttpInfo(List<string> tags)
        {
            // verify the required parameter 'tags' is set
            if (tags == null)
                throw new ApiException(400, "Missing required parameter 'tags' when calling PetApi->FindPetsByTags");
        ...
        /// <param name="petId">ID of pet to return</param>
        /// <returns>Task of ApiResponse (Pet)</returns>
        public async Task<ApiResponse<Pet>> GetPetByIdAsyncWithHttpInfo(long? petId)
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
                throw new ApiException(400, "Missing required parameter 'petId' when calling PetApi->GetPetById");
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> UpdatePetAsyncWithHttpInfo(Pet body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PetApi->UpdatePet");
        ...
        public ApiResponse<Object> UpdatePetWithFormWithHttpInfo(long? petId, string name = null, string status = null)
        {
            ...
            if (petId == null)
                throw new ApiException(400,
                    "Missing required parameter 'petId' when calling PetApi->UpdatePetWithForm");
            ...
            localVarPathParams.Add("petId", Configuration.ApiClient.ParameterToString(petId)); // path parameter
            if (name != null)
                localVarFormParams.Add("name", Configuration.ApiClient.ParameterToString(name)); // form parameter
            if (status != null)
                localVarFormParams.Add("status", Configuration.ApiClient.ParameterToString(status)); // form parameter
        ...
        /// <param name="status">Updated status of the pet (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> UpdatePetWithFormAsyncWithHttpInfo(long? petId, string name = null,
            string status = null)
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
        ...
        /// <param name="_file">file to upload (optional)</param>
        /// <returns>ApiResponse</returns>
        public ApiResponse UploadFile(long? petId, string additionalMetadata = null, Stream _file = null)
        {
        ...
        /// <param name="_file">file to upload (optional)</param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public ApiResponse<ApiResponse> UploadFileWithHttpInfo(long? petId, string additionalMetadata = null,
            Stream _file = null)
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
            ...
            if (additionalMetadata != null)
                localVarFormParams.Add("additionalMetadata",
                    Configuration.ApiClient.ParameterToString(additionalMetadata)); // form parameter
        ...
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse> UploadFileAsync(long? petId, string additionalMetadata = null,
            Stream file = null)
        {
            ApiResponse<ApiResponse> localVarResponse =
        ...
        /// <param name="_file">file to upload (optional)</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async Task<ApiResponse<ApiResponse>> UploadFileAsyncWithHttpInfo(long? petId,
            string additionalMetadata = null, Stream _file = null)
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
                throw new ApiException(400, "Missing required parameter 'petId' when calling PetApi->UploadFile");
            ...
            Exception exception = ExceptionFactory?.Invoke("UploadFile", localVarResponse);
            if (exception != null) throw exception;
